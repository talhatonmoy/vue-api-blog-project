        ...
        this.addBoards = function(boards, isInit) {
          ...
          for (var boardkey in boards) {
            ...
            if (addButton) {
              ...
              btn.setAttribute(
                "class",
                "kanban-title-button inline-block px-8 py-2 m-0 text-xs font-bold text-center text-black uppercase align-middle transition-all border-0 rounded-lg cursor-pointer ease-soft-in leading-pro tracking-tight-soft bg-white shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85"
              );
              btn.appendChild(t);
